...
ALTER TABLE public.admin_audit_logs OWNER TO suvidha;
...
ALTER SEQUENCE public.admin_audit_logs_id_seq OWNER TO suvidha;
...
ALTER TABLE public.departments OWNER TO suvidha;
...
ALTER SEQUENCE public.departments_id_seq OWNER TO suvidha;
...
ALTER TABLE public.notifications OWNER TO suvidha;
...
ALTER SEQUENCE public.notifications_id_seq OWNER TO suvidha;
...
ALTER TABLE public.otps OWNER TO suvidha;
...
ALTER TABLE public.ticket_events OWNER TO suvidha;
...
ALTER SEQUENCE public.ticket_events_id_seq OWNER TO suvidha;
...
ALTER TABLE public.ticket_updates OWNER TO suvidha;
...
ALTER SEQUENCE public.ticket_updates_id_seq OWNER TO suvidha;
...
ALTER TABLE public.tickets OWNER TO suvidha;
...
ALTER SEQUENCE public.tickets_id_seq OWNER TO suvidha;
...
ALTER TABLE public.user_departments OWNER TO suvidha;
...
ALTER TABLE public.user_sessions OWNER TO suvidha;
...
ALTER SEQUENCE public.user_sessions_id_seq OWNER TO suvidha;
...
ALTER TABLE public.users OWNER TO suvidha;
...
ALTER SEQUENCE public.users_id_seq OWNER TO suvidha;
...
ALTER TABLE public.work_orders OWNER TO suvidha;
...
ALTER SEQUENCE public.work_orders_id_seq OWNER TO suvidha;
