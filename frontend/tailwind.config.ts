...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['Noto Sans', 'Poppins', 'system-ui', 'sans-serif'],
        heading: ['Poppins', 'Noto Sans', 'system-ui', 'sans-serif'],
      },
      fontSize: {
        'kiosk-xs': ['0.875rem', { lineHeight: '1.25rem' }],
        'kiosk-sm': ['1rem', { lineHeight: '1.5rem' }],
        'kiosk-base': ['1.125rem', { lineHeight: '1.75rem' }],
        'kiosk-lg': ['1.25rem', { lineHeight: '1.875rem' }],
        'kiosk-xl': ['1.5rem', { lineHeight: '2rem' }],
        'kiosk-2xl': ['1.875rem', { lineHeight: '2.25rem' }],
        'kiosk-3xl': ['2.25rem', { lineHeight: '2.75rem' }],
        'kiosk-4xl': ['3rem', { lineHeight: '3.5rem' }],
        'kiosk-5xl': ['4rem', { lineHeight: '4.5rem' }],
      },
      colors: {
